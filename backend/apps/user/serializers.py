...
from utils.errors import ValidationErrorNew
from utils.serializers import ModelSerializer, Serializer
from utils.constants.status_code import StatusCode
from apps.user.utils import generation_token
...
class UserLoginSerializer(Serializer):
    ...
    password = serializers.CharField(help_text='文章')
